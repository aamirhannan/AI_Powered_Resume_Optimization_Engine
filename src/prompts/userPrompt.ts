...
export const GenerateCriticalAnalysisPrompt = (rewrittenResume: any, jobDescription: string) => `
ROLE:
...
export const generateCoverLetterPrompt = (resume: any, jobDescription: string) => `
ROLE:
...
export const generateSubjectLinePrompt = (resume: any, jobDescription: string) => {
  return `
ROLE:
