...
export const fullStack: Resume = {
    ...
    "professionalSummary": "Full Stack Developer with 2+ years of experience building scalable web applications using React.js, Next.js, Node.js, and TypeScript. Skilled in optimizing APIs (up to 70% faster) and implementing efficient state management. Proficient with REST, GraphQL, and microservices architecture. Leverages AI tools like GitHub Copilot, Cursor, and CodiumAI to improve productivity, code quality, and testing. Strong focus on performance optimization, debugging, and responsive UI design.",
    "education": {
    ...
    "experience": [
        {
            ...
            "responsibilitiesAndAchievements": [
                "Designed and developed scalable frontend applications using **React.js** and **Next.js**, implementing Server-Side Rendering (SSR) and Static Site Generation (SSG) to improve SEO and reduce Time-to-Interactive (TTI) by 40%",

                "Architected global state management utilizing **Redux Toolkit** and **Context API** to maintain consistent application state across complex user flows and real-time data updates",

                "Built a highly responsive and accessibility-compliant (WCAG 2.1) component library using **Material UI (MUI)** and **Tailwind CSS**, accelerating UI development cycles by 30%",

                "Optimized frontend performance by implementing code splitting, image optimization, and lazy loading, resulting in a 25% improvement in Core Web Vitals (LCP/CLS)",

                "Integrated real-time features on the client-side using **Redux** middleware to seamless handle Server-Sent Events (SSE) streams, ensuring zero-latency updates for end-users",
